...
#define DISTANCIA_SENSOR_SERVO_MM   90  // Distancia física del ultrasónico al primer servo
#define ALTURA_SENSOR_PISO_CM       18  // Altura fija de montaje del HC-SR04
...
typedef enum {
    CINTA_FINAL_OFF,
    CINTA_FINAL_IDLE,
    CINTA_FINAL_RETARDO_CENTRADO, // <--- AGREGAR ESTO ACÁ
